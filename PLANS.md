...
- Restored “Calm by design.” as the landing page's only visible statement after copy exploration; kept résumé positioning out of the sparse visual experience and synchronized the Markdown mirror and deployment smoke markers.

...
(() => {
  ...
  scene.initHomeScene = function () {
    ...
    renderer.setClearColor(0, 0), setRendererOutputColorSpace(renderer), renderer.toneMapping = THREE.NoToneMapping, renderer._useLegacyLights = true, renderer.shadowMap.type = THREE.PCFSoftShadowMap, container.appendChild(renderer.domElement);
    ...
    [{
      ...
      canvasTexture6.wrapS = THREE.RepeatWrapping, canvasTexture6.wrapT = THREE.RepeatWrapping, canvasTexture6.repeat.set(1.5, 2), setSrgbTexture(canvasTexture6);
    ...
    function tmpV66(arg78 = 0) {
      ...
      return setSrgbTexture(canvasTexture7), canvasTexture7.anisotropy = chooseAnisotropy(1, 2), canvasTexture7.minFilter = THREE.LinearFilter, canvasTexture7.magFilter = THREE.LinearFilter, canvasTexture7.generateMipmaps = !1, canvasTexture7;
    }
    group4.add(group7);
    ...
    function tmpV67(arg79, arg80, arg81, arg82) {
      ...
      return setSrgbTexture(canvasTexture8), canvasTexture8.minFilter = THREE.LinearFilter, canvasTexture8.magFilter = THREE.LinearFilter, canvasTexture8.generateMipmaps = !1, canvasTexture8;
    }
    ...
    const arr19 = [],
      result106 = function () {
        ...
        return setSrgbTexture(canvasTexture9), canvasTexture9.anisotropy = chooseAnisotropy(1, 2), canvasTexture9;
      }(),
    ...
    const result110 = function () {
        ...
        return canvasTexture17.wrapS = THREE.RepeatWrapping, canvasTexture17.wrapT = THREE.RepeatWrapping, canvasTexture17.repeat.set(2.4, 1.2), canvasTexture17.anisotropy = chooseAnisotropy(2, 6), setSrgbTexture(canvasTexture17), canvasTexture17;
      }(),
    ...
    const driftClouds = [],
      driftCloudTexture = function () {
        ...
        return setSrgbTexture(canvasTexture18), canvasTexture18.anisotropy = chooseAnisotropy(1, 2), canvasTexture18;
      }(),
    ...
    const emberClouds = [],
      emberCloudTexture = function () {
        ...
        return setSrgbTexture(canvasTexture19), canvasTexture19.anisotropy = chooseAnisotropy(1, 2), canvasTexture19;
      }(),

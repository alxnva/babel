    ...
    return runSceneInitialization(subsystemRegistry, () => {
      ...
      var spriteMaterial = new SpriteMaterial({
          map: (function (arg59) {
            ...
            for (var num409 = 0; num409 < 400; num409++) {
              ...
              (result86 > 0.55
                ...
                : result86 > 0.25
                  ...
                  : (gradient10.addColorStop(
                      0,
                      "rgba(60,15,0," + (0.1 + 0.12 * Math.random()) + ")",
                    ),
            ...
            var gradient11 = ctx2.createRadialGradient(
              num407,
              num408,
              153.6,
              num407,
      ...
      ((mesh38.rotation.x = -Math.PI / 2),
        (mesh38.position.y = result107 + 1.6),
        group7.add(mesh38));
      ...
      ((mesh41.rotation.x = -Math.PI / 2),
        (mesh41.position.y = result107 + 0.9),
        group7.add(mesh41));
      const arr24 = [];
            ...
            ? (() => {
                ...
                arr16.forEach((arg8, arg9) => {
                  ...
                  ((arg8.mesh.position.x = Math.cos(num167) * num168),
                    ...
                    (arg8.mesh.position.y =
                      arg8.baseY + 0.35 * Math.sin(0.6 * num166 + 0.3 * arg9)),
        ...
        if (haloSystem.active) {
          ...
          for (let haloIndex = 0; haloIndex < arr9.length; haloIndex += 1) {
            ...
            const orbitTheta =
                ...
                0.15 *
                  Math.sin(elapsedTime * haloRecord.wobble2Freq * 0.3 + 2.3 * haloRecord.phase),
            ...
            const haloScale =
                haloRecord.baseScale *
                (0.85 + 0.15 * Math.sin(1.5 * elapsedTime + haloRecord.phase)),
      ...
      scene.disposeHomeSceneRuntime = function disposeHomeSceneRuntime() {
        ...
        sceneIntersectionObserver = null;
        if (reflectionCaptureFrame !== null && typeof cancelAnimationFrame === "function") {
